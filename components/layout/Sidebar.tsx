        ...
        <div className="flex flex-col gap-6 p-10 pt-6">
          ...
          <div className="flex flex-col">
            ...
            <div className="grid grid-cols-2 gap-x-2 gap-y-1 mt-4">
              <span className="inline-flex items-center justify-center gap-2 px-3 py-2 bg-[#29382F] rounded-[8px] text-xs font-semibold text-[#8DA596]">
          ...
          <div className="bg-sidebar-card border border-sidebar-border rounded-[8px] p-4 flex flex-col gap-4 mt-6">
            ...
            >
              <ArrowLeft className="w-5 h-5 text-brand-green shrink-0" strokeWidth={1.5} />
